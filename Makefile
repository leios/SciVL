...
BINS = SciVL
OBJ = SDL_test.o GL_setup.o distributions.o shape_functions.o aux_functions.o shaders.o operations.o parser.o parg.o platformer.o pong.o fourier.o test_animation.o euclid.o bits.o fft.o verlet.o traverse.o thanks.o convolution.o
